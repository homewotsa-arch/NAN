...
export default function App() {
  ...
  const handleLogoClick = () => {
    ...
    // Match transition duration before showing shop view
    setTimeout(() => {
      setView('shop');
    }, 1200);
  };
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-100 font-sans relative overflow-x-hidden">
      ...
      {(view === 'landing' || view === 'transitioning') && (
        <div className="absolute inset-0 z-50 bg-[#f4f1ea] flex flex-col items-center justify-center cursor-pointer select-none">
          <div 
            onClick={handleLogoClick}
            className="group flex flex-col items-center p-8 transition-transform duration-300 hover:scale-105"
          >
            {/* Logo Image corresponding to user's uploaded emblem */}
      ...
      {/* SHOPPING PAGE VIEW */}
      <div className={`${view !== 'shop' ? 'opacity-0 pointer-events-none' : 'opacity-100 transition-opacity duration-700'} min-h-screen bg-neutral-950 text-neutral-100`}>
