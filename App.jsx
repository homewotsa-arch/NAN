    ...
    <div className="min-h-screen bg-neutral-950 text-neutral-100 font-sans relative overflow-x-hidden">
      ...
      {(view === 'landing' || view === 'transitioning') && (
        <div className="fixed inset-0 z-50 bg-[#f4f1ea] flex flex-col items-center justify-center cursor-pointer select-none">
          ...
          >
            {/* Logo Badge Container featuring user's custom logo image */}
            <div className="w-64 h-64 md:w-80 md:h-80 rounded-full bg-[#fcfbf9] shadow-xl border border-neutral-300/60 flex items-center justify-center p-4 relative overflow-hidden">
              <img 
                src="image_2.png" 
          ...
          {/* Hornbill Flock Animation Overlay using your actual Hornbill artwork */}
          {view === 'transitioning' && (
              ...
              {[...Array(6)].map((_, i) => (
                ...
                >
                  <img 
                    ...
                    style={{ transform: `rotate(${-15 + (i % 3) * 10}deg)` }}
                  />
                </div>
              ))}
            </div>
      ...
      {/* Inline styles for Hornbill soaring animation */}
      <style>{`
          ...
          <div className="max-w-6xl mx-auto px-4 py-3 flex justify-between items-center">
            <div className="flex items-center space-x-3 cursor-pointer" onClick={() => setView('landing')}>
              <div className="w-10 h-10 rounded-full bg-white p-1 flex items-center justify-center border border-neutral-700 shadow">
                <img src="image_2.png" alt="Logo" className="w-full h-full object-contain rounded-full" />
              </div>
