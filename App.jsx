...
import { 
  ...
  Menu, Utensils, Award, PhoneCall, Sparkles, ShoppingCart, MapPin, CreditCard
} from 'lucide-react';
...
const PRODUCTS = [
  ...
  },
  {
    ...
    description: 'Handcrafted spicy chicken sausages smoked with authentic local Nagaland herbs.',
    pairings: ['Pan Fried', 'Grilled', 'Rice Bowl Side']
  },
  {
    id: 'pork-sausage',
    name: 'Naga Smoked Pork Sausage',
    category: 'Sausages',
    heat: 4,
    ...
    description: 'Traditional wood-smoked pork sausages packed with spicy Naga red chilli.',
  ...
  },
  {
    ...
    description: 'A special blend of smoked pork and buffalo meat seasoned with traditional Naga spices.',
...
export default function App() {
  ...
  const [paymentMode, setPaymentMode] = useState('Online Payment (UPI/GPay/PhonePe)');
              ...
              >
                ...
                <div className="p-6 pt-0">
                  ...
                  >
                    ...
                    {product.inStock ? `Add to Cart (${currentOption.label} - ₹{currentOption.price})` : 'Currently Unavailable'}
                  </button>
                </div>
              </div>
            );
